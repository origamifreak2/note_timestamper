...
async function main() {
  ...
  const okJS = await copyIfExists(path.join(srcDir, 'index.min.js'), path.join(dstDir, 'fabric.js'))
...
main().catch(e => { console.error('Failed to copy Fabric.js assets:', e); process.exit(1); });